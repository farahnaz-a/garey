...
<div id="nt_search_canvas" class="nt_fk_full dn tl tc_lg">
    <div class="nt_mini_cart flex column h__100">
        <div class="mini_cart_wrap">
            <form method="get" class="search_header mini_search_frm js_frm_search pr" action="{{ route('frontend.search') }}">
                <div class="row">
                    <div class="frm_search_cat col-auto">
                        <select name="product_type">
                            <option value="*">All Categories</option>
                            @foreach (categories() as $item)
                            <option value="{{ $item->cat_name_en }}">{{ $item->cat_name_en }}</option>
                            ...
                            <div class="row mb__10 pb__10">
                                <div class="col-12">
                                    <div class="img_fix_search">
                                        <a class="db pr oh" href="{{ route('frontend.productDetails', $product->id ?? '') }}"><img src="{{ asset('web_images/products/thumb') }}/{{ $product->id }}.jpg" class="w__100 lazyload" alt="{{ $product->prod_title_en }}" data-bgset="{{ asset('web_images/products/thumb') }}/{{ $product->id }}.jpg"></a>
                                    </div>
                                </div>
                                <div class="col-12 mt__10">
                                    <a class="product-title db" href="{{ route('frontend.productDetails', $product->id ?? '') }}">{{ $product->prod_title_en }}</a>QAR {{ $product->price }}
                                </div>
                            </div>
                        </div>
                        @endforeach
